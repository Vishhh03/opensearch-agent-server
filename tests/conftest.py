...
@pytest.fixture
def configured_specialized_agents(mock_mcp_client: MagicMock) -> Generator[MagicMock, None, None]:
...
# ---------------------------------------------------------------------------
# Server Configuration & Auth Fixtures
# ---------------------------------------------------------------------------


@pytest.fixture
def valid_auth_headers() -> dict[str, str]:
    """Return valid Authorization headers for testing protected endpoints."""
    return {"Authorization": "Bearer test-valid-token"}


@pytest.fixture
def invalid_auth_headers() -> dict[str, str]:
    """Return invalid Authorization headers for testing auth failures."""
