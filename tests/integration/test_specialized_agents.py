...
class TestHypothesisAgent:
    ...
    @pytest.mark.asyncio
    async def test_hypothesis_agent_rate_limit_error(self, configured_specialized_agents):
...
class TestEvaluationAgent:
    ...
    @pytest.mark.asyncio
    async def test_evaluation_agent_rate_limit_error(self, configured_specialized_agents):
...
class TestUserBehaviorAnalysisAgent:
    ...
    @pytest.mark.asyncio
    async def test_user_behavior_analysis_agent_success(self, configured_specialized_agents):
    ...
    @pytest.mark.asyncio
    async def test_user_behavior_analysis_agent_error_handling(self, configured_specialized_agents):
    ...
    @pytest.mark.asyncio
    async def test_user_behavior_analysis_agent_rate_limit_error(self, configured_specialized_agents):
...
class TestSpecializedAgentsErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_user_behavior_agent_missing_data(self, configured_specialized_agents):
    ...
    @pytest.mark.asyncio
    async def test_user_behavior_agent_tool_error_missing_data(self, configured_specialized_agents):
